<project xmlns="com.autoesl.autopilot.project" name="srcnn_hls" top="srcnn_top" projectType="C/C++">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        ...
        <file name="src/srcnn_top.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
    </files>
    <solutions xmlns="">

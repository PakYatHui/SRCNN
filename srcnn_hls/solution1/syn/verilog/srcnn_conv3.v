...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state14)) begin
        acc_3_reg_198 <= grp_fu_704_p_dout0;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        mul_reg_713 <= grp_fu_708_p_dout0;
    end
end
...
assign grp_fu_704_p_din0 = acc_3_reg_198;

assign grp_fu_704_p_din1 = mul_reg_713;

assign grp_fu_704_p_opcode = 2'd0;

assign grp_fu_708_p_ce = 1'b1;

assign grp_fu_708_p_din0 = feat2_load_reg_698;

assign grp_fu_708_p_din1 = bitcast_ln41_fu_592_p1;

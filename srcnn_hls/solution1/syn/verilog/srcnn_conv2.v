...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln12_fu_312_p2 == 1'd0))) begin
        ...
        acc_4_reg_156 <= grp_fu_3418_p_dout0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        mul_reg_521 <= grp_fu_3422_p_dout0;
    end
end
...
assign grp_fu_3418_p_din0 = acc_4_reg_156;

assign grp_fu_3418_p_din1 = mul_reg_521;

assign grp_fu_3418_p_opcode = 2'd0;

assign grp_fu_3422_p_ce = 1'b1;

assign grp_fu_3422_p_din0 = feat1_load_reg_506;

assign grp_fu_3422_p_din1 = bitcast_ln17_fu_413_p1;

    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem_in_mem_depth) begin
                $display ("C:/Xilinx/golden/srcnn_hls/solution1/sim/verilog/AESL_axi_master_gmem_in.v: Write request address %d exceed AXI master gmem_in array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem_in_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem_in_mem_depth) begin
                $display ("C:/Xilinx/golden/srcnn_hls/solution1/sim/verilog/AESL_axi_master_gmem_in.v: Read request address %d exceed AXI master gmem_in array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem_in_mem_depth); 
                $finish;
            end

...
using hls::sim::Byte;
extern "C" void srcnn(Byte<4>*, Byte<4>*, Byte<4>*, int, int, int, int, int, int, int, int);
...
__xlx_input_ftmap__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_ftmap)[i]);
  ...
  // Collect __xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec
std::vector<Byte<4>> __xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec;
for (size_t i = 0; i < 5184; ++i){
__xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_conv1_weights)[i]);
}
...
__xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_conv1_biases)[i]);
}
...
__xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_conv2_weights)[i]);
}
  int __xlx_size_param_conv2_weights = 2048;
  int __xlx_offset_param_conv2_weights = 5248;
  int __xlx_offset_byte_param_conv2_weights = 5248*4;
for (size_t i = 0; i < 32; ++i){
__xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_conv2_biases)[i]);
}
  int __xlx_size_param_conv2_biases = 32;
  int __xlx_offset_param_conv2_biases = 7296;
  int __xlx_offset_byte_param_conv2_biases = 7296*4;
for (size_t i = 0; i < 800; ++i){
__xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_conv3_weights)[i]);
}
  int __xlx_size_param_conv3_weights = 800;
  int __xlx_offset_param_conv3_weights = 7328;
  int __xlx_offset_byte_param_conv3_weights = 7328*4;
for (size_t i = 0; i < 1; ++i){
__xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_conv3_biases)[i]);
}
  int __xlx_size_param_conv3_biases = 1;
  int __xlx_offset_param_conv3_biases = 8128;
  int __xlx_offset_byte_param_conv3_biases = 8128*4;
...
((Byte<4>*)__xlx_apatb_param_conv1_weights)[i] = __xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec[__xlx_offset_param_conv1_weights+i];
}
// print __xlx_apatb_param_conv1_biases
for (size_t i = 0; i < __xlx_size_param_conv1_biases; ++i) {
((Byte<4>*)__xlx_apatb_param_conv1_biases)[i] = __xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec[__xlx_offset_param_conv1_biases+i];
}
// print __xlx_apatb_param_conv2_weights
for (size_t i = 0; i < __xlx_size_param_conv2_weights; ++i) {
((Byte<4>*)__xlx_apatb_param_conv2_weights)[i] = __xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec[__xlx_offset_param_conv2_weights+i];
}
// print __xlx_apatb_param_conv2_biases
for (size_t i = 0; i < __xlx_size_param_conv2_biases; ++i) {
((Byte<4>*)__xlx_apatb_param_conv2_biases)[i] = __xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec[__xlx_offset_param_conv2_biases+i];
}
// print __xlx_apatb_param_conv3_weights
for (size_t i = 0; i < __xlx_size_param_conv3_weights; ++i) {
((Byte<4>*)__xlx_apatb_param_conv3_weights)[i] = __xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec[__xlx_offset_param_conv3_weights+i];
}
// print __xlx_apatb_param_conv3_biases
for (size_t i = 0; i < __xlx_size_param_conv3_biases; ++i) {
((Byte<4>*)__xlx_apatb_param_conv3_biases)[i] = __xlx_conv1_weights_conv1_biases_conv2_weights_conv2_biases_conv3_weights_conv3_biases__tmp_vec[__xlx_offset_param_conv3_biases+i];
}

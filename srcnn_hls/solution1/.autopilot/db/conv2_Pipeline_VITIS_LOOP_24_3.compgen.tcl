...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename in_tile_0 \
    op interface \
    ports { in_tile_0_address0 { O 10 vector } in_tile_0_ce0 { O 1 bit } in_tile_0_we0 { O 1 bit } in_tile_0_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'in_tile_0'"
}
}

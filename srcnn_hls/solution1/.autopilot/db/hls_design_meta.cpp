...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("conv1_weights_address0", 13, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("conv1_weights_ce0", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("conv1_weights_q0", 32, hls_in, 1, "ap_memory", "mem_dout", 1),
...
>>>>>>> b41ed44 (Initial commit)
	...
	Port_Property("conv3_biases", 32, hls_in, 6, "ap_none", "in_data", 1),
	Port_Property("output_ftmap_address0", 16, hls_out, 7, "ap_memory", "mem_address", 1),
	Port_Property("output_ftmap_ce0", 1, hls_out, 7, "ap_memory", "mem_ce", 1),
	Port_Property("output_ftmap_we0", 1, hls_out, 7, "ap_memory", "mem_we", 1),
	Port_Property("output_ftmap_d0", 32, hls_out, 7, "ap_memory", "mem_din", 1),
};

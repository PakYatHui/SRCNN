...
using hls::sim::Byte;
extern "C" void srcnn_top(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, int, int, int, int, int, int, int, int, int, int);
extern "C" void apatb_srcnn_top_hw(volatile void * __xlx_apatb_param_input_ftmap, volatile void * __xlx_apatb_param_conv1_weights, volatile void * __xlx_apatb_param_conv1_biases, volatile void * __xlx_apatb_param_conv1_out, volatile void * __xlx_apatb_param_conv2_weights, volatile void * __xlx_apatb_param_conv2_biases, volatile void * __xlx_apatb_param_conv2_out, volatile void * __xlx_apatb_param_conv3_weights, volatile void * __xlx_apatb_param_conv3_biases, volatile void * __xlx_apatb_param_output_ftmap) {
...
__xlx_conv1_weights_conv1_biases__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_conv1_biases)[i]);
  ...
  // Collect __xlx_conv1_out_conv2_out__tmp_vec
std::vector<Byte<4>> __xlx_conv1_out_conv2_out__tmp_vec;
for (size_t i = 0; i < 4161600; ++i){
__xlx_conv1_out_conv2_out__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_conv1_out)[i]);
}
  int __xlx_size_param_conv1_out = 4161600;
  int __xlx_offset_param_conv1_out = 0;
  int __xlx_offset_byte_param_conv1_out = 0*4;
for (size_t i = 0; i < 2080800; ++i){
__xlx_conv1_out_conv2_out__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_conv2_out)[i]);
}
  int __xlx_size_param_conv2_out = 2080800;
  int __xlx_offset_param_conv2_out = 4161600;
  int __xlx_offset_byte_param_conv2_out = 4161600*4;
...
__xlx_output_ftmap__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_ftmap)[i]);
  ...
  // DUT call
  srcnn_top(__xlx_input_ftmap__tmp_vec.data(), __xlx_conv1_weights_conv1_biases__tmp_vec.data(), __xlx_conv1_out_conv2_out__tmp_vec.data(), __xlx_conv2_weights_conv2_biases__tmp_vec.data(), __xlx_conv3_weights_conv3_biases__tmp_vec.data(), __xlx_output_ftmap__tmp_vec.data(), __xlx_offset_byte_param_input_ftmap, __xlx_offset_byte_param_conv1_weights, __xlx_offset_byte_param_conv1_biases, __xlx_offset_byte_param_conv1_out, __xlx_offset_byte_param_conv2_weights, __xlx_offset_byte_param_conv2_biases, __xlx_offset_byte_param_conv2_out, __xlx_offset_byte_param_conv3_weights, __xlx_offset_byte_param_conv3_biases, __xlx_offset_byte_param_output_ftmap);
...
for (size_t i = 0; i < __xlx_size_param_conv1_out; ++i) {
((Byte<4>*)__xlx_apatb_param_conv1_out)[i] = __xlx_conv1_out_conv2_out__tmp_vec[__xlx_offset_param_conv1_out+i];
}
// print __xlx_apatb_param_conv2_out
for (size_t i = 0; i < __xlx_size_param_conv2_out; ++i) {
((Byte<4>*)__xlx_apatb_param_conv2_out)[i] = __xlx_conv1_out_conv2_out__tmp_vec[__xlx_offset_param_conv2_out+i];
}

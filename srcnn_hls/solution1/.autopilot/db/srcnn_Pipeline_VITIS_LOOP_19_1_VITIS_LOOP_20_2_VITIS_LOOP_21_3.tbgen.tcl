set moduleName srcnn_Pipeline_VITIS_LOOP_19_1_VITIS_LOOP_20_2_VITIS_LOOP_21_3
set isTopModule 0
...
set C_modelName {srcnn_Pipeline_VITIS_LOOP_19_1_VITIS_LOOP_20_2_VITIS_LOOP_21_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ feat1 float 32 regular {array 4161600 { 0 1 } 1 1 } {global 2}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "feat1", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "extern" : 0} ]}
...
set portList { 
	...
	{ feat1_address0 sc_out sc_lv 22 signal 0 } 
	{ feat1_ce0 sc_out sc_logic 1 signal 0 } 
	{ feat1_we0 sc_out sc_logic 1 signal 0 } 
	{ feat1_d0 sc_out sc_lv 32 signal 0 } 
	{ feat1_address1 sc_out sc_lv 22 signal 0 } 
	{ feat1_ce1 sc_out sc_logic 1 signal 0 } 
	{ feat1_q1 sc_in sc_lv 32 signal 0 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4161603", "Max" : "4161603"}
	, {"Name" : "Interval", "Min" : "4161603", "Max" : "4161603"}
]}
...
set Spec2ImplPortList { 
	feat1 { ap_memory {  { feat1_address0 mem_address 1 22 }  { feat1_ce0 mem_ce 1 1 }  { feat1_we0 mem_we 1 1 }  { feat1_d0 mem_din 1 32 }  { feat1_address1 MemPortADDR2 1 22 }  { feat1_ce1 MemPortCE2 1 1 }  { feat1_q1 in_data 0 32 } } }
}

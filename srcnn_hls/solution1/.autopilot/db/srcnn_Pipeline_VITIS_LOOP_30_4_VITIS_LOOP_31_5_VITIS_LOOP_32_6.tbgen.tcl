set moduleName srcnn_Pipeline_VITIS_LOOP_30_4_VITIS_LOOP_31_5_VITIS_LOOP_32_6
set isTopModule 0
...
set C_modelName {srcnn_Pipeline_VITIS_LOOP_30_4_VITIS_LOOP_31_5_VITIS_LOOP_32_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ feat2 float 32 regular {array 2080800 { 0 1 } 1 1 } {global 2}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "feat2", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "extern" : 0} ]}
...
set portList { 
	...
	{ feat2_address0 sc_out sc_lv 21 signal 0 } 
	{ feat2_ce0 sc_out sc_logic 1 signal 0 } 
	{ feat2_we0 sc_out sc_logic 1 signal 0 } 
	{ feat2_d0 sc_out sc_lv 32 signal 0 } 
	{ feat2_address1 sc_out sc_lv 21 signal 0 } 
	{ feat2_ce1 sc_out sc_logic 1 signal 0 } 
	{ feat2_q1 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "feat2_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "feat2", "role": "address1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2080803", "Max" : "2080803"}
	, {"Name" : "Interval", "Min" : "2080803", "Max" : "2080803"}
]}
...
set Spec2ImplPortList { 
	feat2 { ap_memory {  { feat2_address0 mem_address 1 21 }  { feat2_ce0 mem_ce 1 1 }  { feat2_we0 mem_we 1 1 }  { feat2_d0 mem_din 1 32 }  { feat2_address1 MemPortADDR2 1 21 }  { feat2_ce1 MemPortCE2 1 1 }  { feat2_q1 in_data 0 32 } } }
}

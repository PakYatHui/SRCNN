...
#pragma HLS PIPELINE off
 int R = 9 / 2;
    VITIS_LOOP_17_1: for (int oc = 0; oc < 64; oc++) {
       VITIS_LOOP_18_2: for (int y = 0; y < 255; y++) {
             VITIS_LOOP_19_3: for (int x = 0; x < 255; x++) {

              acc = conv1_biases[oc];

                 VITIS_LOOP_23_4: for (int ic = 0; ic < 1; ic++) {
                     VITIS_LOOP_24_5: for (int ky = 0; ky < 9; ky++) {
                         int iy_raw = y + ky - R;
                         int iy;
                         if (iy_raw < 0) {
                             iy = 0;
                         ...
                         VITIS_LOOP_35_6: for (int kx = 0; kx < 9; kx++) {
                             int ix_raw = x + kx - R;
                             int ix;
                             if (ix_raw < 0) {
                                 ix = 0;

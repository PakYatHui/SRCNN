...
__attribute__((sdx_kernel("srcnn_top", 0))) void srcnn_top(ftmap_t input_ftmap[1][255][255],
...
__attribute__((sdx_kernel("srcnn_top", 0))) void srcnn_top(ftmap_t input_ftmap[1][255][255],
               ...
               ftmap_t output_ftmap[1][255][255])
{
#line 30 "C:/Xilinx/golden/srcnn_hls/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=srcnn_top
# 14 "src/srcnn_top.cpp"
           ...
           ftmap_t output_ftmap[1][255][255])
{
    ...
    static ftmap_t conv1_out[64][255][255];
    static ftmap_t conv2_out[32][255][255];

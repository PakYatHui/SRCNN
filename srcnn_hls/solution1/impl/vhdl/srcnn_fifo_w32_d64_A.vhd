...
entity srcnn_fifo_w32_d64_A is
    generic (
...
architecture arch of srcnn_fifo_w32_d64_A is

    -- component
    component srcnn_fifo_w32_d64_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_srcnn_fifo_w32_d64_A_ram : srcnn_fifo_w32_d64_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity srcnn_fifo_w32_d64_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 32;
        ADDR_WIDTH  : integer := 6;
...
architecture arch of srcnn_fifo_w32_d64_A_ram is
